...
| 060 | [Release 1.5.0](archive/060-release-1.5.0.md) | P1 | S–M | 059 (must be merged); before 058 | DONE (2026-09-13, branch advisor/060-release-1.5.0 @ d2b68ea in /tmp/opencode/wt-060, reviewed + verified; seven-feature notes, five-file lockstep 1.5.0, Chrome badge bumped, Firefox badge held at published 1.4.0, full gate green on 1.5.0 zip, no tag pushed — **operator action pending: `git tag v1.5.0 && git push origin v1.5.0` triggers store submission**; 2 plan-criterion arithmetic deltas judged satisfied-in-intent) |
